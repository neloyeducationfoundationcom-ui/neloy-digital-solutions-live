import currentWorker from "./project-wrapper.js";
...
<section id="partners" class="alt">
  <div class="wrap">
    <div class="sectionHead">
      ...
      <p>Official sponsor partner with offices based in the U.K., Malaysia, and Bangladesh.</p>
    </div>
    <div class="card" style="display:grid;grid-template-columns:180px 1fr;gap:28px;align-items:center;max-width:760px;margin:auto">
      ...
      <div>
        <h3 style="margin:0 0 6px;font-size:28px">Top Notch Assignment</h3>
        <div style="color:#29dfff;font-weight:900;margin-bottom:12px">Sponsor Partner</div>
        <p style="margin:0;color:#9fb7cf"><strong style="color:#eef8ff">Office locations:</strong> U.K. • Malaysia • Bangladesh</p>
      </div>
    </div>
  </div>
</section>`;
