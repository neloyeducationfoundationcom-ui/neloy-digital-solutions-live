...
<article class="testCard" style="text-align:center">
  <img src="${CYNTHIA_PHOTO}" alt="Cynthia Gomez" style="width:110px;height:110px;object-fit:cover;border-radius:50%;border:3px solid #29dfff;margin:0 auto 14px;display:block">
  <h3 style="margin-bottom:4px">Cynthia Gomez</h3>
  ...
  if (html.includes(placeholder)) {
    return html.replace(placeholder, card);
  }

  if (html.includes('<section id="testimonials"')) {
    const marker = '<div class="testGrid">';
