...
<section id="nds-video-portfolio" aria-labelledby="nds-video-portfolio-title"><div class="vpWrap"><div class="vpHead"><span>Selected Client & Creative Work</span><h2 id="nds-video-portfolio-title">Video Editing Portfolio</h2><p>Two video-editing examples are shown here so visitors can review the editing style directly before starting a project.</p></div><div class="vpGrid"><article class="vpCard vpReel"><span class="vpTag">Video Editing · Reels</span><h3>Approved Branded Laptop Video</h3><p>The exact Neloy branded laptop video you approved for the first portfolio slot.</p><div class="vpPlayer"><video controls playsinline preload="metadata" aria-label="Neloy Digital Solutions short video editing portfolio"><source src="/showcase-media/neloy-approved-laptop-podcast.mp4?v=1" type="video/mp4">Your browser does not support embedded video.</video></div></article><article class="vpCard vpPodcast"><span class="vpTag">Video Editing · Podcast</span><h3>Real Portfolio. Real Results.</h3><p>Your Neloy branded portfolio presentation with the portfolio video playing inside the laptop frame.</p><div class="vpPlayer"><video controls playsinline preload="metadata" aria-label="Neloy Digital Solutions podcast video editing portfolio"><source src="/showcase-media/neloy-real-portfolio-laptop-60s.mp4?v=1" type="video/mp4">Your browser does not support embedded video.</video></div></article></div><div class="vpMore"><a href="/showcase">View Full Portfolio & Reviews</a></div></div></section>
