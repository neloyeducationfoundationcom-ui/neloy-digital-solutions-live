...
#nds-social-community .socialCard{display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:190px;padding:24px;border:1px solid #c9e8f7;border-radius:22px;background:#fff;box-shadow:0 12px 30px rgba(7,93,255,.08);text-decoration:none;transition:transform .18s ease,box-shadow .18s ease}
...
#nds-social-community .visit{margin-top:14px;padding:8px 12px;border-radius:999px;background:#f3faff;border:1px solid #c9e8f7;color:#075dff;font-size:12px;font-weight:900}
...
@media(max-width:760px){
 ...
 #nds-social-community .socialCard{min-height:155px;padding:20px}
}
</style>`;
  ...
  <div class="socialWrap">
    ...
    <div class="socialGrid">
      <a class="socialCard facebook" href="${FACEBOOK_URL}" target="_blank" rel="noopener noreferrer" aria-label="Open Neloy Digital Solutions Facebook">
        <span class="socialIcon">f</span><span class="platform">Facebook</span><span class="handle">Neloy Digital Solutions</span><span class="visit">View profile</span>
      </a>
      <a class="socialCard instagram" href="${INSTAGRAM_URL}" target="_blank" rel="noopener noreferrer" aria-label="Open Neloy Digital Solutions Instagram">
        <span class="socialIcon">◎</span><span class="platform">Instagram</span><span class="handle">@neloydigital.solutions</span><span class="visit">View profile</span>
      </a>
      <a class="socialCard linkedin" href="${LINKEDIN_URL}" target="_blank" rel="noopener noreferrer" aria-label="Open Neloy Digital Solutions LinkedIn">
        <span class="socialIcon">in</span><span class="platform">LinkedIn</span><span class="handle">Neloy Digital Solutions</span><span class="visit">View profile</span>
      </a>
    </div>
  </div>
</section>`;
...
function addSocials(html, path){
  ...
  // Remove any older injected footer social buttons so the new unified block is not duplicated.
