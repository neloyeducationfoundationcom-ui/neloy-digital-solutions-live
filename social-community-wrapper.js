...
'#nds-social-community .socialWrap{width:min(1100px,calc(100% - 32px));margin:0 auto;text-align:center}' +
...
'#nds-social-community .socialIntro{max-width:720px;margin:12px auto 26px;color:#60758c;font-size:16px;line-height:1.7}' +
'#nds-social-community .socialGrid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:16px}' +
...
'#nds-social-community .tiktok .socialIcon{background:#111}' +
...
'@media(max-width:760px){#nds-social-community{padding:40px 0}#nds-social-community .socialGrid{grid-template-columns:1fr}#nds-social-community .socialCard{min-height:175px;padding:20px}}' +
'</style>';
